...
var availableFlightSeats = 35;
console.log("The number of seats left on this flight are " + availableFlightSeats);

console.log("Step 2:  Cost of Groceries");
var groceriesTotal = 105.53;
console.log("Your total is " + groceriesTotal);
...
var streetAddress  = "1234 Elmo Street Sesame, NV 89000"
...
//  ↓ YOUR CODE HERE ↓
    console.log("The new total with the candy bar is " + (groceriesTotal + 2.15));

    console.log('Fix a Birth Certificate:')
//	A birth certificate was printed incorrectly, change the middle initial to something else
//  ↓ YOUR CODE HERE ↓
    middleInitial = "M";
    console.log("There was a mistake on the birth certificate. The corrected middle initial is " + (middleInitial));
...
//  ↓ YOUR CODE HERE ↓
    var customersFullName = "Tameila N Bolden"
    console.log("The customers full name is " + customersFullName);

    console.log('Introduce a Customer:')
//	Print a line to the console that introduces the customer 
//	including the name, and saying that they live at the address variable
//  ↓ YOUR CODE HERE ↓
    console.log("I would like to introduce you to " + (customersFullName) + ". She lives at " + (streetAddress));
