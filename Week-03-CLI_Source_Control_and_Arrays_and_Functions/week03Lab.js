...
const reversed = alphabetArray.toReversed();
...
/*Step 2: */
console.log("Step 2: " + array1[3]);

/*Step 3: */
console.log("Step 3: " + array1[array1.length - 1]);

/*Step 4: */
const count = array1.push(16,3);
console.log("Step 4: " + array1);

/*Step 5: */
console.log("Step 5: " + array1[3]);
...
/* Step 2: 
let element = ['dishes', 'laundry','grocery shopping']; */
let element = ['dishes', 'laundry','grocery shopping'];
console.log('Step 2: ' + element);

/* Step 3: */

console.log('Step 3: ' + element[0] + ', ' + element[2]);

/* Step 4: */
let yourTodoList = ['wash car', 'take out trash'];
...
myTodoList = ['dishes', 'laundry','grocery shopping,'];
const ourTodoList = [myTodoList, yourTodoList];

console.log(sum(...ourTodoList));
